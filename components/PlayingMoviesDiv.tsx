...
export default function PlayingMoviesDiv({isDataEmpty, playingMovies} : any) {
    ...
    {!isDataEmpty ? (
          <section>
            <div className='flex flex-row gap-3'>
              {playingMovies.results?.slice(startingIndex, endingIndex).map((upcomingMovie: {id: string, vote_average: number, title: string,poster_path: string, backdrop_path: string; } ) => (
